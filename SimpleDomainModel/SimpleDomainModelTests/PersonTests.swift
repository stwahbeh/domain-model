...
class PersonTests: XCTestCase {
  ...
  func testPerson() {
    ...
    XCTAssert(ted.toString() == "[Person: firstName:Ted lastName:Neward age:45 job:nil spouse:nil]", ted.toString())
  }
  ...
  func testAgeRestrictions() {
    ...
    XCTAssert(matt.spouse == nil, matt.toString())
  }
  ...
  func testAdultAgeRestrictions() {
    ...
    XCTAssert(mike.job != nil, mike.toString())
    
    mike.spouse = Person(firstName: "Bambi", lastName: "Jones", age: 42)
    XCTAssert(mike.spouse != nil, mike.toString())
  }
